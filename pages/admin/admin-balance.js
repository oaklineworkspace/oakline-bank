    ...
    try {
      ...
      const { error: transactionError } = await supabase
        ...
        .insert({
          ...
          description: `Admin ${operation} balance: ${operation === 'set' ? 'Set to' : operation === 'add' ? 'Added' : 'Subtracted'} $${amount}`,
          status: 'completed',
      ...
      setMessage(`Balance updated successfully! New balance: $${newBalance.toLocaleString()}`);
      setBalanceAmount('');
